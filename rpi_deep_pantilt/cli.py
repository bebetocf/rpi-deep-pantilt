...
def detect(labels, model_path, video_path, loglevel, ssl, edge_tpu, draw_overlay,csv, rotation):
    '''
    ...
    run_stationary_detect(labels, model_cls, model_path, rotation, draw_overlay, csv, video_path)

...
@click.option('--input_size', required=False, type=int, default=None, help='Input size')
...
def detect(labels, model_path, video_path, save_frame_path, save_frame_freq, imgs_path, det_path, input_size, loglevel, ssl, edge_tpu, draw_overlay,csv, rotation):
    '''
    ...
    run_stationary_detect(labels, model_cls, model_path, rotation, draw_overlay, csv, video_path, save_frame_path, save_frame_freq, imgs_path, det_path, input_size)
